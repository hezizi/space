...
- `Rollup v4.0`，最低 Node.js 版本提升到18，使用基于 SWC 的解析器提高解析速度
...
- `Bun v1.0.4`，修复多个Bug，降低了 Bun.serve() 的内存消耗
...
于10月5-6日举行，众多前端工具如 Nuxt、Astro、Vitest、Bun、Svelte、Rollup 等共同构建了强大且丰富的 Vite 生态系统，Evan You在会议中讲到对 Vite 未来的展望，包括正在开发中的新工具 Rolldown。

> Vite 5

目前还处于beta版，从4迁移到5会有以下调整：
